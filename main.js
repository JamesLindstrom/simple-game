...
function runGame() {
    ...
    var SimpleGame = {
        ...
        currentTick: 0,
        enemyCount: 0,
        enemySpacing: 150, // Spawn an enemy every 150 ticks or every 5 seconds
        enemySpeed: 5,
        paused: false,
        ended: false,
        initialized: false,
        ...
        init: function() {
            ...
            var freshGameSpace = document.createElement('div');
            freshGameSpace.setAttribute('id', 'game-space');
            SimpleGame.space.parentNode.replaceChild(freshGameSpace, SimpleGame.space);
            SimpleGame.space = document.getElementById('game-space');
        ...
        gameOver: function() {
            ...
            setTimeout(SimpleGame.prepareReset, 4500);
        },
